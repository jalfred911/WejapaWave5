# Create a numpy array of strings containing letters 'a' through 'j'
# (inclusive) of the alphabet. Then, use numpy array attributes to
# print the following information about this array:
